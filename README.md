...
|----|-----------|-------|
|LookupSelected|This event will be fired when<br/>the look up value is selected in the dropdown.|`{<br/>"selectedObject" : _selected object in the dropdown_,<br/>"uniqueLookupIdentifier" : _the unique lookup component id_<br/>}`|
